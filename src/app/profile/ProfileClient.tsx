...
const T = {
  en: {
    ...
    decisionText:
      "Use this decision tool to complete your profile and make decisions about your next steps.",
  },
  es: {
    title: "Mi situación",
    ...
    decisionText:
      "Utiliza esta herramienta de decisiones para completar tu perfil y tomar decisiones sobre tus próximos pasos.",
  },
};
