  ...
  const T = {
    en: {
      highFast: {
        ...
        note:
          'Disruption is likely, but delay materially increases downside.',
      },
      high: {
        body:
          'This path prioritizes early intervention. You trade comfort for earlier stabilization.',
        note:
          'Short-term friction is expected. The benefit is reduced tail risk.',
      },
      low: {
        body:
          'This path is optional. You move now to position ahead of future shifts.',
        note:
          'Energy spent now pays off later. Moving too early may add noise.',
      },
      default: {
        body:
          'This path accelerates correction. You accept effort now to simplify later.',
        note:
          'Timing matters. Acting too late erodes the advantage.',
      },
