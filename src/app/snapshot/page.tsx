...
import { computeSnapshot } from '../lib/computeSnapshot'; // Adjust the path if necessary
...
export default function SnapshotPage() {
  ...
  const snapshot = computeSnapshot(profileMock);
  ...
  return (
    <main style={{ maxWidth: 720, margin: '0 auto', padding: 40 }}>
      ...
      >
        <Link
          href={`/paths?lang=${lang}&risk=${risk}&pulse=${pulse}`}
          style={primaryBtn}
        >
          {T.next}
        </Link>
